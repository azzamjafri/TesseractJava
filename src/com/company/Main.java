...
public class Main {
            ...
            throws IOException, TesseractException
    {
        ...
        ImageIO.write(fopimage,"jpg", new File("~/Desktop/0.jpg"));

        // Instantiating the Tesseract class
        // which is used to perform OCR
        Tesseract it = new Tesseract();

        it.setDatapath("~/Downloads/Tess4J/tessdata");
    ...
    {
        File f = new File("home/azzam/Desktop/0.jpg");

        BufferedImage ipimage = ImageIO.read(Main.class.getResource("/resources/images/0.jpg"));
